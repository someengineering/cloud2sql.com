...
We track `cloud2sql.com` website usage using [Plausible Analytics](https://plausible.io).
...
To toggle whether your visits to `cloud2sql.com` are counted, please click the button below.
